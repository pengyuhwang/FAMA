...
class FactorCollection:
    def __init__(self):
        ...
        self.base_dir = "/Users/hpy/PycharmProjects/FAMA"
        self.factor_dir = Path(os.path.join(self.base_dir, "factor_value_prepared", "data", "factors"))
        self.factor_dir.mkdir(parents=True, exist_ok=True)

        with open(self.current_path / "FactorConfig.yaml", "r", encoding="utf-8") as f:
    ...
    def update_talib(self):
        ...
        all_results += calculate_talib(default_cal_start, to_calculate_new_ids, self.native_price, self.price_df)
        # 计算已有标的因子
        ...
        all_results += calculate_talib(cal_start, to_update_ids, self.native_price, self.price_df)
...
def calculate_talib(cal_start, to_calculate_ids, native_price, price_df):
    ...
    for code in to_calculate_ids:
        ...
        _bench_return = price_df["000300.SH"].pct_change()
